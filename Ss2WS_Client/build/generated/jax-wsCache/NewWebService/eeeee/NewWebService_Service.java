 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ssss/", wsdlLocation = "http://localhost:8080/Session2WS/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ssss/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Session2WS/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://ssss/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ssss/", "NewWebServicePort"), NewWebService.class, features);
    }
