...
public class ObjectFactory {
    ...
    private final static QName _SayResponse_QNAME = new QName("http://aaaaa/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://aaaaa/", "say");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: bbbb
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://aaaaa/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://aaaaa/", name = "say")
