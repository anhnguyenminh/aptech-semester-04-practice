 ...
 * 
 */
@WebServiceClient(name = "Hello", targetNamespace = "http://aaaaa/", wsdlLocation = "http://localhost:8080/Session1WS/Hello?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLO_QNAME = new QName("http://aaaaa/", "Hello");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Session1WS/Hello?WSDL");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://aaaaa/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://aaaaa/", "HelloPort"), Hello.class, features);
    }
